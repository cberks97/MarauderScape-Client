...
public final class EntityDef {
	...
	entityDef.aByte68 = 1;
    entityDef.description = "The king of the MarauderScape titans!".getBytes(); // NPC description
	}
    ...
    entityDef.description = "The mighty lord Zamorak's demon K'ril Tsutsaroth!".getBytes(); // NPC description
	}
	if(i == 2555) { // NPC ID 
    entityDef.actions = new String[5];
    entityDef.actions[1] = "Attack";
    ...
    entityDef.description = "The mighty lord Armadyl's general Kree'arra!".getBytes(); // NPC description
	}
	if (i == 2559) {
	...
	entityDef.description = "Big, Black & extremely evil.".getBytes();
	}
	if(i == 82) {
	stream.currentOffset = streamIndices[630]; 
	entityDef.aByte68 = 3;
	...
	entityDef.description = "Lesser, but still pretty big.".getBytes();
	}
