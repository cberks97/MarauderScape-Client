...
//	notifyItemSpawn(item, i + baseX, j + baseY);
 ...
 //	   myPassword = "";
	...
	public static void main(String args[]) {
		try {
			System.out.println("MarauderScape");
			if(args.length != 5) {
	...
	void drawLoadingText(int i, String s)
	{
		...
		char c1 = '\310';
		byte byte1 = 20;
		chatTextDrawingArea.drawText(0xffffff, "MarauderScape", c1 / 2 - 26 - byte1, c / 2);
		int j = c1 / 2 - 18 - byte1;
  ...
  */
	...
	private void login(String s, String s1, boolean flag)
	{
		...
		try
		{
			...
			if(k == 6)
			{
				loginMessage1 = "MarauderScape has been updated!";
 ...
 //		   return;
	...
	private void showErrorScreen()
	{
		...
		if(loadingError)
		{
			...
			int k = 35;
			g.drawString("Sorry, an error has occured whilst loading MarauderScape", 30, k);
			k += 50;
		...
		if(genericLoadingError)
		{
			...
			g.drawString("To play MarauderScape make sure to DL the client", 50, 100);
		...
		if(rsAlreadyLoaded)
		{
			...
			g.setColor(Color.yellow);
			int l = 35;
			g.drawString("Error a copy of MarauderScape already appears to be loaded", 30, l);
			l += 50;
			g.setColor(Color.white);
 ...
 //			   return new DataInputStream((new URL(getCodeBase(), s)).openStream());
	...
	private void drawLoginScreen(boolean flag)
	{
		...
		if(loginScreenState == 0)
		{
			...
			i = c1 / 2 - 20;
			chatTextDrawingArea.method382(0xffff00, c / 2, "Welcome to MarauderScape!", i, true);
			i += 30;
			int l = c / 2 - 80;
			int k1 = c1 / 2 + 20;
		...
		if(loginScreenState == 3)
		{
			...
			int k = c1 / 2 - 35;
			chatTextDrawingArea.method382(0xffffff, c / 2, "Thanks For Trying MarauderScape!", k, true);
			k += 15;
			chatTextDrawingArea.method382(0xffffff, c / 2, "Brought to you by awesome people.", k, true);
			k += 15;
			chatTextDrawingArea.method382(0xffffff, c / 2, "Remember, this is a work in progress.", k, true);
			k += 15;
...
*/
	...
	public void updateStrings(String str, int i) {
		switch(i) {
			...
			case 1677: sendFrame126(str, 17510); break;//Crush
